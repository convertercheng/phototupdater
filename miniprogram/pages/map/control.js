...
//高德地图导航相关
import amapFile from '../../components/utils/amap-wx.js'
const myAmap = new amapFile.AMapWX({
  key: 'a801c56d900eef247f46b8012c5e42a9'
});
//控件图标文件路径
const MapcarIcon = "/miniprogram//assets/icon/ic_home_car.png",
  MappriceIcon = "/miniprogram//assets/icon/ic_home_money.png",
  MapcurrentPositionIcon = "/miniprogram//assets/icon/ic_home_position.png",
  MappersonIcon = "/miniprogram/assets/icon/home_mine@3x.png",
  MapRefreshIcon = "/miniprogram//assets/icon/ic_home_refresh.png";
//makes图标文件
const staticCarIcon = "/miniprogram//assets/icon/ic_map_gray.png",
  centorICon = "/miniprogram//assets/icon/ic_parting_map.png",
  currentcarIcon = '/miniprogram//assets/icon/ic_map_check.png',
  activeCarIcon = '/miniprogram//assets/icon/ic_map_car.png',
  pricecarIcon = '/miniprogram//assets/icon/ic_map_money.png';
  //标记点图标文件
const contenrLogo ="/miniprogram//assets/icon/ic_map_heart.png",
arrowIcon ="/miniprogram//assets/icon/ic_map_start.png";
let timer = null;
