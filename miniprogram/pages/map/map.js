...
//获取应用实例
const app = getApp()
import AJAX from '../../components/utils/netUtil.js';
//深圳同方信息港经纬度，方便模拟
...
//地图控件
import mapControls from './control.js'
import { throttle } from '../../components/utils/threadreturn'
//轮询订单状态的定时器
let tm = null;
let test = false;
Page({
  ...
  onShow() {
    this.throttle = throttle(this.getnearPark)
  ...
  goAppoint() {
    ...
    app.globalData.optionType = 'main';
    app.globalData.parkingInfo.parkingId = nowParking.id;
    wx.setStorageSync('parkingId', nowParking.id)
